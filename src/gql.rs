...
graphql_object!(Query:Context |&self|{
    ...
    field getMyCells(&executor) -> FieldResult<UserResponse>{
        use super::schema::myusers::dsl::*;
...
graphql_object!(Mutation:Context |&self|{
    ...
    field signUp(email:String, first_name:String, last_name:String, password:String, bio:Option<String>, avatar:Option<String>, cells:Option<String>) -> FieldResult<UserResponse> {
        use super::schema::myusers;
        let connection = establish_connection();
    ...
    field changeProfile(&executor, bio:Option<String>, avatar:Option<String>, cells:Option<String>) ->FieldResult<UserResponse>{
